...
# We will see this alot as well, and I will show you visually why this holds.
...
arrows(3, 0.08, 2.5, 0.02, length = .06)
text(-3, 0.1, TeX("$\\alpha/2$"))
text(3, 0.1, TeX("$\\alpha/2$"))
text(0, 0.17, TeX("$1 - \\alpha$"))
mtext(TeX("$z_{\\alpha/2}$"), side = 1, line = 0, at = qnorm(alpha/2))
mtext(TeX("$z_{1-\\alpha/2}$"), side = 1, line = 0, at = qnorm(1-alpha/2))
